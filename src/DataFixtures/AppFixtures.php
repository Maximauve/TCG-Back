...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $card1->setImage('forest_guardian.png');
        ...
        $card2->setImage('thunder_raptor.png');
        ...
        $card3->setImage('abyssal_horror.png');
        ...
        $card4->setImage('crystal_golem.png');
        ...
        $card5->setImage('celestial_seraph.png');
        ...
        $card6->setImage('inferno_titan.png');
        ...
        $card7->setImage('venomous_shade.png');
        ...
        $card8->setImage('tundra_wolf.png');
        ...
        $card9->setImage('chrono_mage.png');
        ...
        $card10->setImage('spectral_pirate.png');
        ...
        $card11->setImage('ironwood_treant.png');
        ...
        $card12->setImage('anniversary_emblem.png');
        ...
        $card13->setImage('convention_exclusive.png');
        ...
        $card14->setImage('first_edition_mark.png');
        ...
        $card15->setImage('desert_nomad.png');
        ...
        $card16->setImage('plasma_elemental.png');
        ...
        $card17->setImage('mercenary_captain.png');
        ...
        $card18->setImage('necropolis_lord.png');
        ...
        $card19->setImage('sky_fortress.png');
        ...
        $card20->setImage('goblin_alchemist.png');
